...
import com.kimhong.project_final.adapter.ProductMainAdapter;
...
public class MainActivity extends AppCompatActivity implements ProductMainAdapter.OnProductClickListener  {
    ...
    private void updateProductsUI(List<ProductResponse.Product> products) {
        ProductMainAdapter adapter = new ProductMainAdapter(products);
